...
import { applyTopLevelDefaults, findConfig, loadConfig, validate } from '../src/config.js';
...
describe('config', () => {
  ...
  it('throws clearly on invalid config shape', () => {
    expect(() =>
      validate({ packages: [{ targetPackage: 'x', allow: { include: 'not-array' } }] }),
    ).toThrow();
  });
        ...
        packages: [
          {
            ...
            patterns: {
              ...
              hooks: [
                { name: 'useFoo', modelArgIndex: 0, argStyle: 'imported-identifier' },
              ],
            },
          },
        ],
        ...
        packages: [
          {
            ...
            patterns: {
              ...
              depth: { member: 1, operation: 2 },
              hooks: [
                { name: 'useFoo', argIndex: 0, argStyle: 'imported-identifier' },
              ],
            },
            packageStructure: {
              layout: 'flat',
